...
from src.lightning.lightning_sg import PL_SG
...
def main():
    ...
    model = PL_SG(config, pretrained_ckpt=args.ckpt_path, profiler=profiler)
    ...
    # TensorBoard Logger
    logger = TensorBoardLogger(save_dir='/media/seu/900e5312-66bd-4294-88cf-b812b223aed2/pami', name=args.exp_name, default_hp_metric=False)
